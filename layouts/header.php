        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="preguntas.php" class="nav-item nav-link">
                    ...
                    <a href="javascript:abrir () " class="nav-item nav-link">
                        ...
                        <div class="sobre" id="sobre">
                            <h1>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facilis, commodi esse ullam
                                quis
                                maiores vitae provident soluta, ut animi reiciendis nisi nam qui temporibus suscipit!
                                Eius
